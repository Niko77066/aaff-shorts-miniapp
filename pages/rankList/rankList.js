Page({
  ...
  loadItems() {
    ...
    var gradientColors = [
      ['#00A896', '#00C9B0'], ['#2563eb', '#60a5fa'], ['#0891b2', '#22d3ee'],
      ['#ea580c', '#fb923c'], ['#059669', '#34d399'], ['#d97706', '#fbbf24'],
      ['#00A896', '#34d399'], ['#0891b2', '#22d3ee'], ['#0284c7', '#38bdf8'],
      ['#be123c', '#fb7185'], ['#15803d', '#4ade80'], ['#0d9488', '#2dd4bf'],
      ['#0d9488', '#2dd4bf'], ['#c2410c', '#fdba74'], ['#00A896', '#00C9B0']
    ]
